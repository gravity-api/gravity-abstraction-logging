...
## Logger.Trace(string, System.Exception) Method
Logs a "Trace" message.  
```csharp
public void Trace(string message, System.Exception exception);
```
#### Parameters
<a name='Gravity-Abstraction-Logging-Logger-Trace(string_System-Exception)-message'></a>
`message` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The message to log.  
  
<a name='Gravity-Abstraction-Logging-Logger-Trace(string_System-Exception)-exception'></a>
