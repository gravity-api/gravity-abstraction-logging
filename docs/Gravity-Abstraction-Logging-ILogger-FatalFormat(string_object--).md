...
## ILogger.FatalFormat(string, object[]) Method
Logs a fatal message.  
```csharp
void FatalFormat(string format, params object[] args);
```
#### Parameters
<a name='Gravity-Abstraction-Logging-ILogger-FatalFormat(string_object--)-format'></a>
`format` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
Format string for the message to log  
  
<a name='Gravity-Abstraction-Logging-ILogger-FatalFormat(string_object--)-args'></a>
