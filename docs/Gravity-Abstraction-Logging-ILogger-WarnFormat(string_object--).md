...
## ILogger.WarnFormat(string, object[]) Method
Logs a warn message.  
```csharp
void WarnFormat(string format, params object[] args);
```
#### Parameters
<a name='Gravity-Abstraction-Logging-ILogger-WarnFormat(string_object--)-format'></a>
`format` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
Format string for the message to log  
  
<a name='Gravity-Abstraction-Logging-ILogger-WarnFormat(string_object--)-args'></a>
