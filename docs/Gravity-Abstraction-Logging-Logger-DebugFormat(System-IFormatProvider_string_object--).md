...
## Logger.DebugFormat(System.IFormatProvider, string, object[]) Method
Logs a "Debug" message.  
```csharp
public void DebugFormat(System.IFormatProvider formatProvider, string format, params object[] args);
```
#### Parameters
<a name='Gravity-Abstraction-Logging-Logger-DebugFormat(System-IFormatProvider_string_object--)-formatProvider'></a>
...
<a name='Gravity-Abstraction-Logging-Logger-DebugFormat(System-IFormatProvider_string_object--)-format'></a>
`format` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
Format string for the message to log.  
  
<a name='Gravity-Abstraction-Logging-Logger-DebugFormat(System-IFormatProvider_string_object--)-args'></a>
