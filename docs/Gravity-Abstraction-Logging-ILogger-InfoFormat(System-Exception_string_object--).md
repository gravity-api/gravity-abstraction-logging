...
## ILogger.InfoFormat(System.Exception, string, object[]) Method
Logs an info message.  
```csharp
void InfoFormat(System.Exception exception, string format, params object[] args);
```
#### Parameters
<a name='Gravity-Abstraction-Logging-ILogger-InfoFormat(System-Exception_string_object--)-exception'></a>
`exception` [System.Exception](https://docs.microsoft.com/en-us/dotnet/api/System.Exception 'System.Exception')  
The exception to log  
  
<a name='Gravity-Abstraction-Logging-ILogger-InfoFormat(System-Exception_string_object--)-format'></a>
`format` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
Format string for the message to log  
  
<a name='Gravity-Abstraction-Logging-ILogger-InfoFormat(System-Exception_string_object--)-args'></a>
