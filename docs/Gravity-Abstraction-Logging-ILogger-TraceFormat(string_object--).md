...
## ILogger.TraceFormat(string, object[]) Method
Logs a trace message.  
```csharp
void TraceFormat(string format, params object[] args);
```
#### Parameters
<a name='Gravity-Abstraction-Logging-ILogger-TraceFormat(string_object--)-format'></a>
`format` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
Format string for the message to log  
  
<a name='Gravity-Abstraction-Logging-ILogger-TraceFormat(string_object--)-args'></a>
