...
## ILogger.Warn(string, System.Exception) Method
Logs a warn message.  
```csharp
void Warn(string message, System.Exception exception);
```
#### Parameters
<a name='Gravity-Abstraction-Logging-ILogger-Warn(string_System-Exception)-message'></a>
`message` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The message to log  
  
<a name='Gravity-Abstraction-Logging-ILogger-Warn(string_System-Exception)-exception'></a>
