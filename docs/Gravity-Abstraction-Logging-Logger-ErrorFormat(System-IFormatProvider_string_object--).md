...
## Logger.ErrorFormat(System.IFormatProvider, string, object[]) Method
Logs an "Error" message.  
```csharp
public void ErrorFormat(System.IFormatProvider formatProvider, string format, params object[] args);
```
#### Parameters
<a name='Gravity-Abstraction-Logging-Logger-ErrorFormat(System-IFormatProvider_string_object--)-formatProvider'></a>
...
<a name='Gravity-Abstraction-Logging-Logger-ErrorFormat(System-IFormatProvider_string_object--)-format'></a>
`format` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
Format string for the message to log.  
  
<a name='Gravity-Abstraction-Logging-Logger-ErrorFormat(System-IFormatProvider_string_object--)-args'></a>
